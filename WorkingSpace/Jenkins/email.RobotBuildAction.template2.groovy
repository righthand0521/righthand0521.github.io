  ...
  <table class="section">
    ...
    <tr>
      <td>Report:</td>
        ...
        %>
      <td><A href="http://192.168.0.1/${jobName}/${buildNumber}/report.html">http://192.168.0.1/${jobName}/${buildNumber}/report.html</A></td>
    </tr>
    <tr>
      <td>Note:</td>
      <td>If the report has fail test result, maybe it meets some error in Environment.<br>No mind! It would run again or run more times.<br>If it still fails, we will check it manually.</td>
    </tr>
  </table>
  <br/>
