...
```
# apt install libssl-dev libssh-dev libidn11-dev libpcre3-dev libgtk2.0-dev libmysqlclient-dev libpq-dev libsvn-dev firebird-dev libmemcached-dev libgpg-error-dev libgcrypt20-dev -y
# cd /opt; mkdir hydra; cd hydra
# wget https://github.com/vanhauser-thc/thc-hydra/archive/8.6.tar.gz; tar -zxvf 8.6.tar.gz; cd thc-hydra-8.6
